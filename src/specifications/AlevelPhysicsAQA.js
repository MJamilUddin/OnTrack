			...
			2.1: {
				...
				spec: {
					2.11: {
						...
						spec: {
							2.111: "Simple model of the atom, including the proton, neutron and electron. Charge and mass of the proton, neutron and electron in SI units and relative units. ",
							2.112: "The atomic mass unit (amu) is included in the A-level Nuclear physics section. ",
							2.113: "Specific charge of the proton and the electron, and of nuclei and ions. ",
					...
					2.12: {
						...
						spec: {
							2.121: "The strong nuclear force; its role in keeping the nucleus stable; short-range attraction up to approximately 3 fm, very-short range repulsion closer than approximately 0.5 fm.",
							2.122: " Unstable nuclei; alpha and beta decay. ",
							2.123: "Equations for alpha decay, β− decay including the need for the neutrino. ",
							2.124: "The existence of the neutrino was hypothesised to account for conservation of energy in beta decay.",
						},
					},
					2.13: {
						"sub-topic": "Particles, antiparticles and photons",
						spec: {
							2.131: "For every type of particle, there is a corresponding antiparticle. ",
							2.132: "Comparison of particle and antiparticle masses, charge and rest energy in MeV.",
							2.134: " Students should know that the positron, antiproton, antineutron and antineutrino are the antiparticles of the electron, proton, neutron and neutrino respectively. ",
							2.135: "Photon model of electromagnetic radiation, the Planck constant.",
							2.136: "Formula 3.2.1.3",
							2.137: " Knowledge of annihilation and pair production and the energies involved. ",
					...
					2.14: {
						...
						spec: {
							2.141: "Four fundamental interactions: gravity, electromagnetic, weak nuclear, strong nuclear. (The strong nuclear force may be referred to as the strong interaction.) ",
							2.142: "The concept of exchange particles to explain forces between elementary particles. ",
							2.143: "Knowledge of the gluon, Z 0 and graviton will not be tested. ",
							2.144: "The electromagnetic force; virtual photons as the exchange particle.",
							2.145: " The weak interaction limited to β−and β + decay, electron capture and electron–proton collisions; W + and W − as the exchange particles. ",
							2.146: "Simple diagrams to represent the above reactions or interactions in terms of incoming and outgoing particles and exchange particles.",
						},
					},
					2.15: {
						...
						spec: {
							...
							2.152: " The two classes of hadrons:\n • baryons (proton, neutron) and antibaryons (antiproton and antineutron)\n • mesons (pion, kaon).",
							2.153: "Baryon number as a quantum number. ",
							2.154: "Conservation of baryon number. ",
							2.155: "The proton is the only stable baryon into which other baryons eventually decay.",
							2.156: " The pion as the exchange particle of the strong nuclear force. ",
							2.157: "The kaon as a particle that can decay into pions.",
							2.158: " Leptons: electron, muon, neutrino (electron and muon types only) and their antiparticles. ",
							2.159: "Lepton number as a quantum number; conservation of lepton number for muon leptons and for electron leptons. ",
							2.1510: "The muon as a particle that decays into an electron. ",
							2.1511: "Strange particles ",
							2.1512: "Strange particles as particles that are produced through the strong interaction and decay through the weak interaction (eg kaons).",
							2.1513: "Strangeness (symbol s) as a quantum number to reflect the fact that strange particles are always created in pairs. ",
							2.1514: "Conservation of strangeness in strong interactions. ",
							2.1515: "Strangeness can change by 0, +1 or -1 in weak interactions.",
							2.1516: " Appreciation that particle physics relies on the collaborative efforts of large teams of scientists and engineers to validate new knowledge.",
						},
					},
					2.16: {
						"sub-topic": "Quarks and antiquarks",
						spec: {
							2.161: "Properties of quarks and antiquarks: charge, baryon number and strangeness. ",
							2.162: "Combinations of quarks and antiquarks required for baryons (proton and neutron only), antibaryons (antiproton and antineutron only) and mesons (pion and kaon only).",
							2.163: " Only knowledge of up (u), down (d) and strange (s) quarks and their antiquarks will be tested. ",
					...
					2.17: {
						...
						spec: {
							...
							2.172: " Application of the conservation laws for charge, baryon number, lepton number and strangeness to particle interactions. The necessary data will be provided in questions for particles outside those specified.",
							2.173: " Students should recognise that energy and momentum are conserved in interactions.",
						},
					},
				},
			},
			2.2: {
				...
				spec: {
					2.21: {
						...
						spec: {
							2.211: "Threshold frequency; photon explanation of threshold frequency. ",
							2.212: "Work function ϕ, stopping potential.",
							2.213: " Photoelectric equation: h f = ϕ + Ek (max) ",
							2.214: "Ek (max) is the maximum kinetic energy of the photoelectrons. ",
							2.215: "The experimental determination of stopping potential is not required.",
						},
					},
					2.22: {
						"sub-topic": "Collisions of electrons with atoms",
						spec: {
							2.221: "Ionisation and excitation; understanding of ionisation and excitation in the fluorescent tube.",
							2.222: " The electron volt.",
							2.223: " Students will be expected to be able to convert eV into J and vice versa.",
						},
					},
					2.23: {
						"sub-topic": "Energy levels and photon emission",
						spec: {
							2.231: "Line spectra (eg of atomic hydrogen) as evidence for transitions between discrete energy levels in atoms.",
							2.232: " h f = E1 − E2",
					...
					2.24: {
						...
						spec: {
							2.241: "Students should know that electron diffraction suggests that particles possess wave properties and the photoelectric effect suggests that electromagnetic waves have a particulate nature. ",
							2.242: "Details of particular methods of particle diffraction are not expected.",
							2.243: " de Broglie wavelength λ = h/mv where mv is the momentum.",
							2.244: "Students should be able to explain how and why the amount of diffraction changes when the momentum of the particle is changed.",
							2.245: " Appreciation of how knowledge and understanding of the nature of matter changes over time. ",
							2.246: "Appreciation that such changes need to be evaluated through peer review and validated by the scientific community",
						},
					},
				},
			},
				...
				spec: {
					3.11: {
						...
						spec: {
							...
							3.112: "amplitude, frequency, wavelength, speed, phase, phase difference, c = f λ , f =1/T ",
							3.113: "Phase difference may be measured as angles (radians and degrees) or as fractions of a cycle.",
						},
					},
					3.12: {
						...
						spec: {
							...
							3.122: " Examples to include: sound, electromagnetic waves, and waves on a string. ",
							3.123: "Students will be expected to know the direction of displacement of particles/fields relative to the direction of energy propagation and that all electromagnetic waves travel at the same speed in a vacuum. ",
							3.124: "Polarisation as evidence for the nature of transverse waves.",
							3.125: " Applications of polarisers to include Polaroid material and the alignment of aerials for transmission and reception. ",
							3.126: "Malus’s law will not be expected.",
						},
					},
					3.13: {
						"sub-topic": "Principle of superposition of waves and formation of stationary waves",
						spec: {
							3.131: "Stationary waves. ",
							3.132: "Nodes and antinodes on strings. ",
							3.133: "The formation of stationary waves by two waves of the same frequency travelling in opposite directions. ",
				...
				spec: {
					3.21: {
						...
						spec: {
							...
							3.212: "Interference and diffraction using a laser as a source of monochromatic light. ",
							3.213: "Young’s double-slit experiment: the use of two coherent sources or the use of a single source with double slits to produce an interference pattern. ",
							3.214: "Fringe spacing, w = λD/s ",
							3.215: "Production of interference pattern using white light. ",
							3.216: "Students are expected to show awareness of safety issues associated with using lasers.",
							3.217: " Students will not be required to describe how a laser works. ",
							3.218: "Students will be expected to describe and explain interference produced with sound and electromagnetic waves.",
							3.219: " Appreciation of how knowledge and understanding of nature of electromagnetic radiation has changed over time.",
						},
					},
					3.22: {
						"sub-topic": "Diffraction",
						spec: {
							3.221: "Appearance of the diffraction pattern from a single slit using monochromatic and white light. ",
							3.222: "Qualitative treatment of the variation of the width of the central diffraction maximum with wavelength and slit width. The graph of intensity against angular separation is not required. ",
							3.223: "Plane transmission diffraction grating at normal incidence. ",
					...
					3.23: {
						...
						spec: {
							...
							3.232: " Students should recall that the refractive index of air is approximately 1. ",
							3.233: "Snell’s law of refraction for a boundary n1sin θ1 = n2sin θ2 ",
							3.234: "Total internal reflection sin θc = n2/n1 ",
							3.235: "Simple treatment of fibre optics including the function of the cladding. ",
							3.236: "Optical fibres will be limited to step index only. ",
							3.237: "Material and modal dispersion. ",
							3.238: "Students are expected to understand the principles and consequences of pulse broadening and absorption.",
						},
					},
				},
			},
				...
				spec: {
					4.11: {
						...
						spec: {
							...
							4.112: " Examples should include:  \n velocity/speed, mass, force/weight, acceleration, displacement/distance. ",
							4.113: "Addition of vectors by calculation or scale drawing.",
							4.114: " Calculations will be limited to two vectors at right angles. Scale drawings may involve vectors at angles other than 90°. ",
							4.115: "Resolution of vectors into two components at right angles to each other.",
							4.116: " Examples should include components of forces along and perpendicular to an inclined plane. ",
							4.117: "Problems may be solved either by the use of resolved forces or the use of a closed triangle. ",
							4.118: "Conditions for equilibrium for two or three coplanar forces acting at a point. Appreciation of the meaning of equilibrium in the context of an object at rest or moving with constant velocity.",
						},
					},
					4.12: {
						"sub-topic": "Moments",
						spec: {
							...
							4.122: "Moment defined as force × perpendicular distance from the point to the line of action of the force. ",
							4.123: "Couple as a pair of equal and opposite coplanar forces.",
							4.124: "Moment of couple defined as force × perpendicular distance between the lines of action of the forces. ",
							4.125: "Principle of moments.",
							4.126: " Centre of mass.",
							4.127: " Knowledge that the position of the centre of mass of uniform regular solid is at its centre.",
						},
					},
					4.13: {
						...
						spec: {
							...
							4.132: "Calculations may include average and instantaneous speeds and velocities. ",
					...
					4.14: {
						...
						spec: {
							4.141: "Independent effect of motion in horizontal and vertical directions of a uniform gravitational field. Problems will be solvable using the equations of uniform acceleration.",
							4.142: "Qualitative treatment of friction.",
							4.143: "Distinctions between static and dynamic friction will not be tested. ",
					...
					4.15: {
						...
						spec: {
							4.151: "Knowledge and application of the three laws of motion in appropriate situations. ",
					...
					4.16: {
						...
						spec: {
							...
							4.163: "Principle applied quantitatively to problems in one dimension. ",
							...
							4.168: "Quantitative questions may be set on forces that vary with time. Impact forces are related to contact times (eg kicking a football, crumple zones, packaging)",
							4.169: "Elastic and inelastic collisions; explosions.",
							4.1610: " Appreciation of momentum conservation issues in the context of ethical transport design.",
						},
					},
					4.17: {
						...
						spec: {
							...
							4.172: " rate of doing work = rate of energy transfer, P = ∆ W/ ∆ t = Fv ",
							4.173: "Quantitative questions may be set on variable forces. ",
							4.174: "Significance of the area under a force–displacement graph.",
					...
					4.18: {
						...
						spec: {
							...
							4.183: " Quantitative and qualitative application of energy conservation to examples involving gravitational potential energy, kinetic energy, and work done against resistive forces.",
						},
					},
				},
			},
				...
				spec: {
					4.21: {
						...
						spec: {
							...
							4.214: "Tensile strain and tensile stress. Elastic strain energy, breaking stress. ",
							4.215: " formula 3.4.2.1",
							4.216: "Description of plastic behaviour, fracture and brittle behaviour linked to force–extension graphs. ",
							4.217: "Quantitative and qualitative application of energy conservation to examples involving elastic strain energy and energy to deform. ",
					...
					4.22: {
						...
						spec: {
							...
							4.222: "Use of stress–strain graphs to find the Young modulus. (One simple method of measurement is required.)",
						},
					},
				},
			},
			...
			5.1: {
				...
				spec: {
					5.11: {
						...
						spec: {
							5.111: "Electric current as the rate of flow of charge; potential difference as work done per unit charge. ",
					...
					5.12: {
						...
						spec: {
							5.121: "For an ohmic conductor, semiconductor diode, and filament lamp. ",
							5.122: "Ohm’s law as a special case where I ∝ V under constant physical conditions.",
							5.123: " Unless specifically stated in questions, ammeters and voltmeters should be treated as ideal (having zero and infinite resistance respectively). ",
							5.124: "Questions can be set where either I or V is on the horizontal axis of the characteristic graph.",
						},
					},
					5.13: {
						...
						spec: {
							...
							5.132: " Description of the qualitative effect of temperature on the resistance of metal conductors and thermistors. ",
							5.133: "Only negative temperature coefficient (ntc) thermistors will be considered. ",
							5.134: "Applications of thermistors to include temperature sensors and resistance–temperature graphs.",
							5.135: " Superconductivity as a property of certain materials which have zero resistivity at and below a critical temperature which depends on the material. ",
							5.136: "Applications of superconductors to include the production of strong magnetic fields and the reduction of energy loss in transmission of electric power. ",
					...
					5.14: {
						...
						spec: {
							...
							5.142: "The relationships between currents, voltages and resistances in series and parallel circuits, including cells in series and identical cells in parallel.",
							5.143: " Conservation of charge and conservation of energy in dc circuits.",
						},
					},
					5.15: {
						"sub-topic": "Potential divider",
						spec: {
							5.151: "The potential divider used to supply constant or variable potential difference from a power supply.",
							5.152: " The use of the potentiometer as a measuring instrument is not required. ",
							5.153: "Examples should include the use of variable resistors, thermistors, and light dependent resistors (LDR) in the potential divider.",
						},
					},
					5.16: {
						...
						spec: {
							...
							5.162: " Students will be expected to understand and perform calculations for circuits in which the internal resistance of the supply is not negligible.",
						},
					},
				},
			},
			...
			6.1: {
				...
				spec: {
					6.11: {
						...
						spec: {
							6.111: "Motion in a circular path at constant speed implies there is an acceleration and requires a centripetal force. ",
							...
							6.116: "The derivation of the centripetal acceleration formula will not be examined. ",
					...
					6.12: {
						...
						spec: {
							6.121: "Analysis of characteristics of simple harmonic motion (SHM). ",
							6.122: "Condition for SHM: a ∝ − x ",
							6.123: "Defining equation: a = − ω 2 x ",
							6.124: "equation 3.6.1.2 ",
							6.125: "Graphical representations linking the variations of x, v and a with time.",
							6.126: " Appreciation that the v − t graph is derived from the gradient of the x − t graph and that the a − t graph is derived from the gradient of the v − t graph. ",
					...
					6.13: {
						...
						spec: {
							...
							6.133: "Questions may involve other harmonic oscillators (eg liquid in U-tube) but full information will be provided in questions where necessary. ",
							6.134: "Variation of Ek , Ep , and total energy with both displacement and time. ",
					...
					6.14: {
						...
						spec: {
							...
							6.142: " Resonance and the effects of damping on the sharpness of resonance.",
							6.143: " Examples of these effects in mechanical systems and situations involving stationary waves.",
						},
					},
				},
			},
			6.2: {
				...
				spec: {
					6.21: {
						...
						spec: {
							6.211: "Internal energy is the sum of the randomly distributed kinetic energies and potential energies of the particles in a body. ",
							6.212: "The internal energy of a system is increased when energy is transferred to it by heating or when work is done on it (and vice versa), eg a qualitative treatment of the first law of thermodynamics.",
							6.213: " Appreciation that during a change of state the potential energies of the particle ensemble are changing but not the kinetic energies. Calculations involving transfer of energy.  ",
							6.214: "For a change of temperature: Q = mc ∆ θ where c is specific heat capacity.",
							6.215: " Calculations including continuous flow. ",
							6.216: "For a change of state Q = ml where l is the specific latent heat.",
						},
					},
					6.22: {
						"sub-topic": "Ideal gases (A-level only)",
						spec: {
							6.221: "Gas laws as experimental relationships between p, V, T and the mass of the gas.",
							6.222: " Concept of absolute zero of temperature.",
							6.223: "Ideal gas equation: pV = nRT for n moles and pV = NkT for N molecules. ",
							6.224: "Work done = p∆V ",
					...
					6.23: {
						...
						spec: {
							...
							6.232: " Explanation of relationships between p, V and T in terms of a simple molecular model.",
							6.233: " Students should understand that the gas laws are empirical in nature whereas the kinetic theory model arises from theory. ",
							6.234: "Assumptions leading to including derivation of the equation and calculations. ",
							6.235: "A simple algebraic approach involving conservation of momentum is required. ",
							6.236: "Appreciation that for an ideal gas internal energy is kinetic energy of the atoms. ",
							6.237: "Use of average molecular kinetic energy = 3.6.2.3 ",
							6.238: "Appreciation of how knowledge and understanding of the behaviour of a gas has changed over time.",
						},
					},
				},
			},
				...
				spec: {
                    ...
                    7.23: {
                        ...
                        spec: {
							...
							7.235: " Idea that no work is done when moving along an equipotential surface.",
				...
				spec: {
                    ...
                    7.33: {
                        ...
                        spec: {
							...
							7.335: " Magnitude of V in a radial field given by formula 3.7.3.3",
				...
				spec: {
                    ...
                    8.13: {
                        ...
                        spec: {
							...
							8.135: " Questions may be set which require students to use formula 3.8.1.3",
							8.136: " Questions may also involve use of molar mass or the Avogadro constant. ",
					...
					8.16: {
                        ...
                        spec: {
							...
							8.166: " Simple calculations from nuclear masses of energy released in fission and fusion reactions. ",
				...
				spec: {
					...
					11.24: {
                        ...
                        spec: {
							...
							11.247: " Engine efficiency; overall, thermal and mechanical efficiencies.",
				...
				spec: {
					...
					13.64: {
                        ...
                        spec: {
							...
							13.646: "Students will be expected to identify the carrier frequency and the information frequency from a graph of the variation of signal voltage with time. ",
